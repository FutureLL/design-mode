package com.future.abstract_factory_pattern;
...
import com.future.abstract_factory_pattern.handler.producer.FactoryProducer;

/**
 * @Description: TODO 抽象工厂模式（Abstract Factory Pattern）
 * @Author: lilei58
 * @Date: Created in 2022/5/12 上午8:17
 *
